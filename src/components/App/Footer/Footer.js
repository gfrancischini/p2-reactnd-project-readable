        ...
        <section className="container">
            ...
            <div className="social_icons f_right">
                <ul>
                    ...
                    <li className="gplus"><a original-title="Google plus" className="tooltip-n" href="https://plus.google.com/+GabrielFrancischini"><i className="social_icon-gplus font17"></i></a></li>
                </ul>
            </div>
        </section>
    </footer>
